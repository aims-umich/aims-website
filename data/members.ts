...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    ...
    department:
      "Department of Statistics, Department of Computer Science and Engineering",
    slug: "yikuny",
  },
  {
    id: "malradai",
    ...
    education: [
      ...
      "Jordan University of Science and Technology (2019)",
  ...
  },
  {
    ...
    education: [
      "Moscow Engineering Physics Institute (2023)",
      "University of Manchester (2015)",
      "University of Port Harcourt (2014)",
      "Ahmadu Bello University (2008)",
    ],
    degrees: [
    ...
    department:
      "Department of Nuclear and Radiological Engineering & Michigan Institute of Data and AI in Society",
  ...
  },
  {
    ...
    education: [
      ...
      "University of Dhaka, Bangladesh (2023)",
      "University of Dhaka, Bangladesh (2022)",
    ],
    degrees: [
  ...
  },
  {
    ...
    degrees: [
      "Masters Degree, Nuclear Engineering and Management",
      "Bachelors Degree, Physics Engineering",
  ...
  },
  {
    ...
    education: [
      "Korea Atomic Energy Research Institute (2011-Present)",
      "University of Minnesota (2011)",
      "Korea Advanced Institute of Science & Technology (2009)",
      "Korea Advanced Institute of Science & Technology (2003)",
      "Korea Advanced Institute of Science & Technology (2000)",
    ],
    degrees: [
      "Senior Researcher",
      "Postdoc, Department of Aerospace Engineering and Mechanics",
  ...
  },
  {
    ...
    department: "Department of Nuclear Engineering and Radiological Sciences",
    website:
      "https://scholar.google.com/citations?user=m2ihttps://scholar.google.com/citations?user=t0ymJ1gAAAAJ&hl=enR6vcAAAAJ&hl=en",
    slug: "jacc",
  },
  {
    id: "jelenes",
  ...
  },
  {
    ...
    education: ["University of Michigan"],
    degrees: [
      "B.S.E in Computer Science Engineering, 2021",
      "B.S.E in Nuclear Engineering and Radiological Sciences, 2021",
    ],
    department: "Department of Nuclear Engineering and Radiological Sciences",
  ...
  },
  {
    ...
    degrees: [
      "M.S.E in Nuclear Engineering and Radiological Sciences, 2023",
  ...
  },
  {
    ...
    degrees: [
      "M.S.E in Robotics, 2025",
      "B.Tech in Computer Science and Computational Mathematics, 2021",
    ],
    department: "Robotics",
  ...
  },
  {
    ...
    degrees: [
      "PhD Nuclear Engineering and Radiological Sciences, Present",
      "BSE Nuclear Engineering and Radiological Sciences, 2023",
    ],
    department: "Department of Nuclear Engineering and Radiological Sciences",
  ...
  },
  {
    ...
    degrees: [
      "M.S.E in Computer Science, 2026",
      "B.A in Enviroment and Information Studies, 2024",
    ],
  ...
  },
  {
    ...
    degrees: [
      "B.S. in Physics and Mechanincal Engineering (Double Major), August 2019-May 2025",
    ],
    department: "Department of Nuclear Engineering and Radiological Sciences",
  ...
  },
  {
    ...
    education: ["University of Michigan"],
    degrees: ["BS in Data Science (2024-28)"],
    department: "LSA Department of Statistics",
    linkedin: "https://www.linkedin.com/in/yejin-son/",
    slug: "yjson",
  },
  {
    id: "qasiddiq",
    name: "Qasim Siddiq",
    email: "qasiddiq@umich.edu",
    status: "Graduate",
    role: "MS Student",
    joinedDate: "August 2025",
    imageUrl: "/people/qasiddiq.jpg",
    heroImageUrl: "/heroImages/qasiddiq.jpg",
    bio: "Qasim Siddiq is a Master’s student in the Department of Nuclear Engineering and Radiological Sciences at the University of Michigan. He earned his B.Eng. in Engineering Physics from McMaster University in Canada, where he focused on the application of neural networks to predict void fraction using fast neutron computed tomography. His research interests include reactor physics, reactor design, Monte Carlo methods, and the integration of machine learning in the nuclear field. He previously worked at AMD in CAD Methodologies for one year, where he gained experience with scripting, regression testing, and large-scale software workflows. Outside of school, Qasim enjoys going to the gym, bouldering, cooking, and playing video games.",
    interests: ["Neutronics", "Reactor Design", "Machine Learning"],
    education: ["University of Michigan", "McMaster University"],
    degrees: ["MS", "B.Eng in Engineering Physics"],
    department: "Department of Nuclear Engineering and Radiological Sciences",
    website:
      "https://scholar.google.com/citations?user=cbJZg4YAAAAJ&hl=en&oi=sra",
    linkedin: "https://www.linkedin.com/in/qasim-siddiq/",
    slug: "qasiddiq",
  },
  {
    id: "shahyug",
    name: "Yug Shah",
    email: "shahyug@umich.edu",
    status: "Undergraduate",
    role: "Undergraduate",
    joinedDate: "September 2025",
    imageUrl: "/people/shahyug.jpeg",
    heroImageUrl: "/heroImages/shahyug.jpeg",
    bio: "I am an undergraduate student in Computer Engineering with a strong interest in software development and systems design. I enjoy using my skills in programming and hardware design to create practical and innovative solutions. Outside of academics, I like watching sports and hanging out with my friends.",
    interests: [
    ...
    education: ["University of Michigan"],
    degrees: ["B.S.E in Computer Engineering (August 2025 - May 2028)"],
    department: "Department of Electrical and Computer Engineering",
    linkedin: "http://www.linkedin.com/in/yug-shah1",
    slug: "shahyug",
  },
  {
    id: "miloparr",
    name: "Milo Parrott",
    email: "miloparr@umich.edu",
    status: "Graduate",
    role: "MS Student",
    joinedDate: "August 2025",
    ...
    education: ["University of Michigan", "University of Michigan"],
    degrees: [
      "M.S.E. in Nuclear Engineering, 2026",
      "B.S.E. in Nuclear Engineering w/ Physics Minor, 2025",
    ],
    department: "Department of Nuclear Engineering and Radiological Sciences",
  ...
  },
  {
    ...
    education: ["University of Michigan", "Rensselaer Polytechnic Institute"],
    degrees: [
      "MS in Nuclear Engineering and Radiological Science (2025-present)",
      "Dual BS in Nuclear and Mechanical Engineering, Rensselaer Polytechnic Institute (2021-2025)",
    ],
    department: "Department of Nuclear Engineering and Radiological Sciences",
    slug: "cfruble",
  },
  {
    ...
    email: "sshamant@umich.edu",
    status: "Undergraduate",
    role: "Undergraduate",
    joinedDate: "August 2025",
    imageUrl: "/people/sshamant.jpeg",
    heroImageUrl: "/heroImages/sshamant.jpeg",
    bio: "Shamanth Shastry is an Undergraduate student studying Computer Science at the University of Michigan College of Engineering. His research interest is in autonomous control systems and the applications of ML/AI in multiphysics simulations. Starting February of 2025, he contributed as a developer to open-source pyMAISE (Michigan Artificial Intelligence Standard Environment), where he analyzed the performance of classical models and neural networks on applications ranging from reactor physics to heat conduction. To connect with his community of origin, he conducted two online workshops to 120 high schoolers in Bangalore, India, teaching them applications of AI/ML, holding demos using Teachable Machine. Locally, he has also worked from 2023 June to 2025 August as a Programming Instructor at iCode School Franchise, teaching middle and high schoolers a wide range of programming skills. In his free time, he enjoys playing basketball, badminton, and chess.",
    interests: ["Machine Learning", "Radiation Mapping", "Data Analysis"],
    education: ["University of Michigan"],
    degrees: ["B.S.E in Computer Science"],
    department: "Department of Computer Science and Engineering",
    slug: "sshamant",
  },
  {
    id: "seydousene",
    name: "Seydou Laara Sene",
    email: "seydou.sene@ensta-paris.fr",
    status: "Alumni",
    role: "Undergraduate",
    joinedDate: "June 2024",
    imageUrl: "/people/seydousene.jpg",
    heroImageUrl: "",
    bio: "Seydou Sene is a Machine Learning Engineer and graduate student at Institut Polytechnique de Paris, working as a Secure Communications and AI Engineering Apprentice at Thales until Fall 2026. At Thales, he automated secure document rewriting workflows using state-of-the-art LLMs and secured over $5K in equipment investment in order to impact more than 400K defense personnel. During his summer 2024 research internship at the University of Michigan's Nuclear Engineering department, he did AI research on thermal storage tank behavior analysis that resulted in a peer-reviewed conference paper presented at the American Nuclear Society's NPIC&HMIT 2025 in Chicago. He earned second place in multiple hackathons, including the MIT Sloan AI Club Global AI Hackathon in August 2025 among over 150 teams.",
    interests: [
      "Multiphysics Simulations",
      "Reactor Design",
      "Large Language Models",
    ...
    education: [
      ...
      "Cité Scolaire Carnot Dijon",
    ],
    degrees: [
      "M.Sc. Equivalent in Computer Science (September 2023 - September 2026)",
      "B.Sc. Equivalent in Engineering — Preparatory Classes for Engineering Schools (MPI*) (September 2021 - June 2023)",
    ],
    department: "Department of Nuclear Engineering and Radiological Sciences",
    linkedin: "https://www.linkedin.com/in/seydou-sene/",
    website: "https://github.com/Sensey181",
    slug: "seydousene",
  },
  {
    id: "alexxu",
    name: "Alex Xu",
    email: "alexxu@umich.edu",
    status: "Alumni",
    role: "Undergraduate",
    joinedDate: "May 2024",
    imageUrl: "/people/alexxu.jpg",
    heroImageUrl: "",
    bio: "Alex graduated from the University of Michigan in 2025 with a BS in Math and Computer Science. His interests include both applications of and the theory behind machine learning. After graduation, his first job is as a computational scientist developing AI surrogate models for physics-based simulations.",
    interests: [
      "Machine Learning",
      "Explainable AI",
      "Multiphysics Simulations",
    ...
    education: ["University of Michigan"],
    degrees: ["BS Mathematics and Computer Science (May 2025)"],
    department: "Department of Computer Science and Engineering",
    slug: "alexxu",
  },
  {
    id: "ohwangkwon",
    name: "O Hwang Kwon",
    email: "army17929@kma.ac.kr",
    status: "Alumni",
    role: "MS Student",
    joinedDate: "May 2024",
    imageUrl: "/people/ohwangkwon.png",
    heroImageUrl: "",
    bio: "2014~2018 Korean Westpoint | 2018~2022 1st / 2nd LT (Platoon Leader, Aide de camp) | 2022~2024 University of Michigan (NERS/ M.S. Nuclear Engineering) | 2024~2025 Chief of Nuclear Characterization Team | 2025~ Assistant Professor of Korean Westpoint, Department of Mechanical Engineering",
    interests: ["Large Language Models", "Parallel Computing"],
    education: ["University of Michigan"],
    degrees: ["M.S. Nuclear Engineering (2022-2024)"],
    department: "Department of Nuclear Engineering and Radiological Sciences",
    linkedin: "https://www.linkedin.com/in/o-hwang-kwon-42b442266/",
    slug: "ohwangkwon",
  },
  {
    id: "vedajoynt",
    name: "Veda Joynt",
    email: "joynt002@gmail.com",
    status: "Alumni",
    role: "Undergraduate",
    joinedDate: "June 2022",
    imageUrl: "/people/vedajoynt.png",
    heroImageUrl: "",
    bio: "Veda Joynt is a master’s student and researcher with experience in nuclear engineering, computational modeling, and data-driven analysis. She has contributed to projects at the Max Planck Institute, the University of Michigan, and SLAC National Accelerator Laboratory, working on topics from Markov modeling and radiation detection to sentiment analysis of nuclear energy and photonic crystal fiber research. Skilled in Python, MATLAB, and scientific communication, she brings an interdisciplinary approach to advancing energy and technology research.",
    interests: ["GANS - t2i image generation", "Large Language Models"],
    education: ["Leuphana University", "University of Michigan", "Libearal Arts and Sciences"],
    degrees: ["Masters (ongoing - August 2026)", "Bachelors (August 2023)", "Associates Degree (December 2020)"],
    department: "Department of Nuclear Engineering and Radiological Sciences",
    slug: "vedajoynt",
  },
];
